...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('7402ef02-fc7f-4e19-b44a-4613ee2526c5/sounds/use.mp3')
  equipClip = new AudioClip('7402ef02-fc7f-4e19-b44a-4613ee2526c5/sounds/KeyEquip.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('7402ef02-fc7f-4e19-b44a-4613ee2526c5/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('7402ef02-fc7f-4e19-b44a-4613ee2526c5/models/Iron_Key_Fantasy.glb'))
    key.addComponent(
      new OnPointerDown(
        () => {
