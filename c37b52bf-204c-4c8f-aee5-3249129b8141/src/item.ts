...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('c37b52bf-204c-4c8f-aee5-3249129b8141/sounds/use.mp3')
  equipClip = new AudioClip('c37b52bf-204c-4c8f-aee5-3249129b8141/sounds/KeyEquip.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('c37b52bf-204c-4c8f-aee5-3249129b8141/images/Key.png')
