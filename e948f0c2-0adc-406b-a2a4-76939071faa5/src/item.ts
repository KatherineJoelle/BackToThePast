...
export default class Timer implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    board.addComponent(new GLTFShape('e948f0c2-0adc-406b-a2a4-76939071faa5/models/CountdownTimerBase.glb'))
    ...
    arrow.addComponent(new GLTFShape('e948f0c2-0adc-406b-a2a4-76939071faa5/models/CountdownTimerPointer.glb'))
