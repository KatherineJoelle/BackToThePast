...
export default class Button implements IScript<Props> {
  clip = new AudioClip('0764e129-9fff-4158-98f0-6db8665dcf7b/sounds/click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    button.addComponent(new GLTFShape('0764e129-9fff-4158-98f0-6db8665dcf7b/models/Lever_SciFi.glb'))
