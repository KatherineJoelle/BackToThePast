...
export default class Button implements IScript<Props> {
  clip = new AudioClip('63cf389e-d14f-4b1a-8bd3-abccb5682255/sounds/siren.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    siren.addComponent(new GLTFShape('63cf389e-d14f-4b1a-8bd3-abccb5682255/models/Siren.glb'))
