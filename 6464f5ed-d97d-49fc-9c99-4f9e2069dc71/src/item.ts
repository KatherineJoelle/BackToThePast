...
export default class TrapDoor implements IScript<Props> {
  openClip = new AudioClip('6464f5ed-d97d-49fc-9c99-4f9e2069dc71/sounds/TrapDoor.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    door.addComponent(new GLTFShape('6464f5ed-d97d-49fc-9c99-4f9e2069dc71/models/Wooden_Trap_Door.glb'))
    ...
    collider.addComponent(new GLTFShape('6464f5ed-d97d-49fc-9c99-4f9e2069dc71/models/TrapDoor_collider.glb'))
