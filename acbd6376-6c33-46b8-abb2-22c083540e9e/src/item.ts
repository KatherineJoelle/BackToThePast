...
export default class PadLock implements IScript<Props> {
  spinClip = new AudioClip('acbd6376-6c33-46b8-abb2-22c083540e9e/sounds/Button_Press.mp3')
  solveClip = new AudioClip('acbd6376-6c33-46b8-abb2-22c083540e9e/sounds/Resolve.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    padLock.addComponent(new GLTFShape('acbd6376-6c33-46b8-abb2-22c083540e9e/models/padlock/Padlock_base.glb'))
    ...
    wheel1.addComponent(new GLTFShape('acbd6376-6c33-46b8-abb2-22c083540e9e/models/padlock/Padlock_roulette.glb'))
    ...
    wheel2.addComponent(new GLTFShape('acbd6376-6c33-46b8-abb2-22c083540e9e/models/padlock/Padlock_roulette.glb'))
    wheel2.addComponent(
      new OnPointerDown(
        e => {
    ...
    wheel3.addComponent(new GLTFShape('acbd6376-6c33-46b8-abb2-22c083540e9e/models/padlock/Padlock_roulette.glb'))
    wheel3.addComponent(
      new OnPointerDown(
        e => {
    ...
    wheel4.addComponent(new GLTFShape('acbd6376-6c33-46b8-abb2-22c083540e9e/models/padlock/Padlock_roulette.glb'))
    wheel4.addComponent(
      new OnPointerDown(
        e => {
