...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('9d1d8101-5c1f-4a92-9603-b8e01b06bb48/sounds/use.mp3')
  canvas = new UICanvas()
  container = new UIContainerStack(this.canvas)
  texture = new Texture('9d1d8101-5c1f-4a92-9603-b8e01b06bb48/images/Key.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    key.addComponent(new GLTFShape('9d1d8101-5c1f-4a92-9603-b8e01b06bb48/models/Head_Access_Card.glb'))
    key.addComponent(
           new OnPointerDown(() => {
